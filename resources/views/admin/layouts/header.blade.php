                            ...
                            <svg class="icon icon-xs" x-description="Heroicon name: solid/search"
                                ...
                                <path fill-rule="evenodd"
                                    d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6
                                        6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
                            ...
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M18 10a8 8 0 11-16 0 8 8 0 0116
                                        0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546
                            ...
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98
                                        ...
                                        2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0
                                        2.978a1.532 1.532 0 01.947
                                        2.287c-.836 1.372.734 2.942 2.106
                                        2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561
                                        2.978 0a1.533 1.533 0 012.287-.947c1.372.836
                                        2.942-.734 2.106-2.106a1.533
                                        1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532
